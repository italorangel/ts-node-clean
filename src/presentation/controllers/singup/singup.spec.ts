...
import { EmailValidator, AccountModel, AddAccount, AddAccountModel } from './singup-protocol'
...
describe('SignUp Controller', () => {
  ...
  test('should return 400 if no passwordConfirmation is not provided', async () => {
    const { sut } = makesut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('should return 400 if an email is not valid', async () => {
